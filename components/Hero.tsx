        ...
        <div className="relative z-20  flex w-[268px] flex-col gap-8 rounded-3xl bg-blue-70 px-7 py-8">
            ...
            <div className="flex flex-col">
                <div className="flexBetween">
                    <p className="regular-16 text-gray-20">localizacao</p>
                    <Image src= "/closee.svg" alt="close" width={24} height={24}/>
                </div>

                <p className="bold-20 text-white">Aguas</p>
                </div>

                <div className="flexBetween">
                    <div className="flex flex-col">
                        <p  className="regular-16 block text-gray-20">Distancia</p>
                        <p className="bold-20 text-white">111.00 mi</p>
                    </div>
                    <div className="flex flex-col">
                        <p  className="regular-16 block text-gray-20">elevacao</p>
